...
-- CreateIndex
CREATE UNIQUE INDEX "token_usage_tenantId_userId_month_year_key" ON "token_usage"("tenantId", "userId", "month", "year");

-- AddForeignKey
ALTER TABLE "store_locations" ADD CONSTRAINT "store_locations_tenantId_fkey" FOREIGN KEY ("tenantId") REFERENCES "tenants"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "roster_folders" ADD CONSTRAINT "roster_folders_tenantId_fkey" FOREIGN KEY ("tenantId") REFERENCES "tenants"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "token_usage" ADD CONSTRAINT "token_usage_tenantId_fkey" FOREIGN KEY ("tenantId") REFERENCES "tenants"("id") ON DELETE CASCADE ON UPDATE CASCADE;
